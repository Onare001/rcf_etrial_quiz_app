export const quizData = {
    ...
    questions: [
      { 
      question: '   Doubling the volume of an ideal gas at constant temperature will ',
      ...
      { 
      question: '   According to the kinetic theory, molecules of different gasses at the same temperature always have the same   ',
      options: [' Average density ', ' Volume', 'Pressure ', 'Average kinetic energy '],
      answer: 'Average kinetic energy'
      },
      { 
      question: 'As solid elements melts, the atom becomes __ and they have ___ attraction for one another  ',
      options: [' Closer together, more ', 'More separated, more  ', 'Larger greater ', 'More separated, less '],
      answer: 'More separated, less'
      },
      { 
      question: '  The tendency of an electrode to release to or attract electron from the surrounding electrolyte solution at 298K temperature 1atm pressure and 1ml/dm3 conc. Is known as ',
      ...
      { 
      question: ' The molar solubility of lead (II) Log in Sign up chloride is 1.5 � 10^-2 mol/dm 3. What is the solubility product of the salt? ',
      options: ['3.0 x 10^-2 ', '30.0 x 10^-2 ', '4.0 x 10^-2 ', ' 1.5 x 10^-2'],
      answer: '1.5 x 10^-2'
      },
      { 
      question: 'When dH is negative, the reaction is said to be ',
      options: [' Endothermic ', ' Exothermic', ' Reversible', ' Catalytic'],
      answer: 'Exothermic'
      },
      { 
      question: ' Which of the following statement is true of an acid conjugate base?',
      ...
      { 
      question: 'The pK of the base XOH, YOH and ZOH are 2.70, 8.60 and 4.50 respectively. Arrange them in order of increasing strength ',
      options: [' XOH, YOH, ZOH', ' YOH, XOH, ZOH ', 'XOH, ZOH, YOH ', ' YOH, ZOH, XOH' ],
      answer: 'YOH, ZOH, XOH'
      },
      { 
      question: ' The property of substance that relate to its ability to form new substances are labeled  ',
      options: ['Physical ', 'Chemical ', ' Extensive', 'Intensive '],
      answer: 'Chemical'
      },
      { 
      question: '  An example of physical change produce by addition of energy is ',
      options: ['Lighting of a match ', 'Burning ', 'Melting of ice ', ' Condensation of steam'],
      answer: 'Melting of ice'
      },
      { 
      question: ' Which of the following is true? If two gases under the same conditions have the same number of molecule then they must (i) have the same number of molecule (ii) occupy the same volume (iii) different number of molecules (iv) occupy different volume ',
      options: ['I only ', 'I and ii ', 'ii and iii ', 'iii and iv '],
      answer: 'I and ii'
      },
      { 
      question: 'In thermo chemistry, the reference standard state for gases, liquid and solid is said to be at ',
      options: ['25 C/1 atm ', ' 0C /10 atm', ' 1C/60atm', '1273K/10atm '],
      answer: '25C/1atm'
      },
      { 
      question: ' The thermodynamic state Log in Sign up function that is a measure of disorderliness is  ',
      options: ['Lavoiser', 'Dalton ', 'Proust ', ' Boyta'],
      answer: 'Lavoiser'
      },
      { 
      question: 'The salt resulting from the reaction of both strong acid and base is likely to be a/an  ',
      options: ['Acid Salt ', ' Basic Salt', ' Neutral', 'No reaction '],
      answer: 'Neutral'
      },
      { 
      question: 'Lowry Bronsted defines acid as  ',
      options: [' A proton acceptor', ' An electron acceptor', ' A proton donor', 'An electron donor '],
      answer: 'A proton donor'
      },
      { 
      question: ' Energy can neither be created nor destroyed but can be converted from one form to other is inferred from. ',
      ...
      { 
      question: ' What happens when a catalyst is added to a system at equilibrium?    ',
