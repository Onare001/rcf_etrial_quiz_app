export const quizData = {
    ...
    questions: [
      { 
      question: 'Which of the following is not a classification of statistics?   ',
      ...
      { 
      question: 'the study of all objects  possessing common characteristics is ?',
      options: ['census', 'statistics scope', 'parameter', 'population'],
      answer: 'population '
      },
      { 
      question: '   ………….  Is the characteristics of description obtained from a population    ',
      options: ['questionnaire', 'parameter', 'census', 'experiment'],
      answer: 'parameter'
      },
      { 
      question: 'all but one of the following is not a type of scale in statistics?',
      options: ['nominal scale', 'ratio scale', 'sampling scale', 'ordinal scale '],
      answer: 'sampling scale'
      },
      { 
      question: ' ……… scale is meant for identification',
      options: ['sampling', 'nominal', 'ratio', 'ordinal'],
      answer: 'nominal'
      },
      { 
      question: 'which of the following experimental method eliminates interviewers bias ?',
      options: ['observation', 'direct interview', 'group interview', 'questionnaire'],
      answer: 'questionnaire'
      },
      { 
      question: '  which of the following is not a classification of sampling?   ',
      ...
      { 
      question: 'in which of the following sampling types is population divided into stratas ',
      options: ['stratified random sampling', 'simple stratified sampling', 'stratified systematic sampling', 'cluster sampling '],
      answer: ' stratified random sampling'
      },
      { 
      question: '  variables in statistics can be divided into …… types     ',
      options: ['4', '2 ', '3', '5'],
      answer: '2'
      },
      { 
      question: 'statistical experiment has two types which are ',
      ...
      { 
      question: 'find the standard deviation if the variance is 9 ',
      options: ['3', '9', '27 ', '81 '],
      answer: '3'
      },
      { 
      question: '  find the mode of 8,4,4,3,6,8,9,6,7,6,2      ',
      options: ['8', '6', '4', '2'],
      answer: '6'
      },
      { 
      question: '   calculate the mean deviation of 2,4,6,8     ',
      options: ['2.0', ' 4.5', '4.0', '5.1'],
      answer: '2.0'
      },
      { 
      question: '2,4,6,8. If the mean of this distribution is 5, calculate the sum of their deviation from the mean ',
      options: ['1', '-1', '0', '2 '],
      answer: '0 '
      },
      { 
      question: '  calculate the mean of 48,45,75,39,51,47,50,47     ',
      options: ['50.30', '50.25', '50.35', '50.15'],
      answer: '50.25'
      },
      { 
      question: 'obtain the arithmetic mean of 8,3,5,12 ',
      options: ['7', '8', '4 ', '5 '],
      answer: '7'
      },
      { 
      question: 'if the mean of 1,3,4,5,7 is 4, find the sum of the square of their deviation from the mean.    ',
      options: ['25', '20', '18', '24'],
      answer: '20'
      },
      { 
      question: 'calculate the standard deviation and the variance of 2,4,6,8    ',
      options: ['2.0 & 3.2', '3.0 &9.0', '. 4.0 &16.0 ', ' 2.6 & 6.7'],
      answer: '2.6 & 6.7'
      },
      { 
      question: '  obtain the mode of 4,1,2,4,3,3,2,5,4,5,3,1,3     ',
      options: ['4', '3', '2', '1'],
      answer: '3'
      },
      { 
      question: 'obtain the mean and median of 1,2,3,4,5 ',
