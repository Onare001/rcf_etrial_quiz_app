export const quizData = {
    ...
    questions: [
      ...
      { 
      question: ' Which of the following are the correct S.I unit of the quantities indicated I. N( Force) ii. N/m (Torque) iii. Watt( power) IV. Kg/ms^-2(momentum)  ',
      options: ['I and ii only ', 'I,II and iii only ', ' I,iii and iv only ', 'I and iii only '],
      answer: 'I and iii only'
      },
      { 
      question: ' For which of the under listed quantities is the derived unit ML^2T^-2 correct i. Moment of force ii. Work iii. Acceleration.  ',
      options: ['I only ', 'ii only ', 'I and ii only ', 'ii and iii only '],
      answer: 'I and ii only'
      },
      { 
      question: ' An object moves 4m eastward (E) and then 3m southwards (S). Its displacement from the original position is   ',
      options: ['1m SE ', '5m SE ', ' 7m SE', ' 12m SE'],
      answer: ' 5m SE'
      },
      { 
      question: ' The distance xm travelled by a particle in time t seconds is described by the equation x= 10+2t^2, Find the average speed of the particle between the time interval t=2seconds and t=5seconds',
      options: ['60m/s', '72m/s' , '108m/s', '84m/s'],
      answer: '84m/s'
      },
      {question: 'A vector A =3units at an angle 60° with vector B=3units that acts along the positive y-axis of the xy plane. What is the resultant vector along the positive y-axis',
      ...
      { 
      question: ' During same interval, it is observed that a train travels the same distance as does a lorry. The two vehicles therefore have the same',
      options: [' Uniform acceleration ', '  instantaneous velocity ', 'initial velocity ', ' average speed'],
      answer: 'average speed'
      },
      { 
      question: 'Which of the following is true of a body which is moving in a straight line with uniform acceleration? The velocity of the body     ',
      ...
      { 
      question: 'A body starts from rest and moves in a straight path with uniform acceleration of 8m/s^2 for 5seconds. It then decelerates uniformly to rest in the next 10seconds. Calculate the magnitude of its acceleration.   ',
      options: ['80m/s^2 ', '16m/s^2 ', '8m/s^2 ', '4m/s^2 '],
      answer: ' 4m/s^2'
      },
      { 
      question: '  A body falls from rest to the ground in 0.5 seconds. Calculate the height from which it falls ( g=10m/s^2) ',
      ...
      { 
      question: 'Newton`s first law of motion states that a body continues in its state of rest or uniform motion in a straight line unless ',
      ...
      { 
      question: 'The property of a body to remain at rest, or to continue to move in a straight line is known as ',
      options: ['inertia ', 'force ', 'impulse ', 'momentum '],
      answer: 'inertia'
      },
      { 
      question: ' A ball of mass 5.0kg lifts a smooth vertical wall normally with a speed of 2m/s and rebounds with the same speed. Determine the impulse experienced by the ball ',
      options: ['20kgms^-1 ', '10kgms^-1  ', '1.5kgms^-1  ', '1.3kgms^-1  '],
      answer: '20kgms^-1'
      },
      { 
      question: 'The impact of two colliding object is said to be perfectly elastic if ',
      ...
      { 
      question: ' A machine gun with a mass of 5kg fires a 50g bullet of a speed of 100m/s.The recoil speed of the machine gun is  ',
      options: [' 0.5m/s', '1.5m/s ', '1m/s ', ' 2m/s'],
      answer: '1m/s'
      },
      { 
      question: ' A particle is projected vertically upwards with a velocity of 20m/s.What Maximum height does it attain (g=10m/s^2)',
      options: ['2000m ', ' 200m', '20m ', '2m '],
      answer: '20m'
      },
      { 
      question: ' A ball is thrown vertically upwards from the ground with an initial velocity of 50m/s. what is the total time spent by the ball in the air? (g=10m/s^2) ',
